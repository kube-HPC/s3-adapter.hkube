...
class S3Adapter {
    ...
    async getCustomData(options) {
        const data = await this._get(options);
        return { data: data.Body, headerInData: false, metadata: validator.decodeMetadata(data.Metadata) };
    }
    ...
    async getMetadata(options) {
        ...
        return { size: data.ContentLength, headerInData: false, metadata: validator.decodeMetadata(data.Metadata) };
    }
